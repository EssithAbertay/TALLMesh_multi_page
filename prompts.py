...
"Preset 1: >15 Codes, Long Quotes" : """Generate a comprehensive set of initial codes (at least 15) for thematic analysis based on the provided text. Focus on capturing all significant explicit and latent meanings or events, emphasizing the respondent's perspective rather than the interviewer's.
...
""",
"Preset 2: >15 Codes, Short Quotes" : """Generate a comprehensive set of initial codes (at least 15) for thematic analysis based on the provided text. Focus on capturing all significant explicit and latent meanings or events, emphasizing the respondent's perspective rather than the interviewer's.
...
reduce_duplicate_codes_prompts = {
    "Preset 1": """Analyze the following list of codes and their descriptions. Identify and merge any duplicate or highly similar codes. For each set of merged codes, provide:
...
For unique codes that are not merged, keep them as they are. Ensure that the merged codes accurately represent the combined meanings of the original codes. The goal is to reduce redundancy while maintaining the richness and nuance of the original coding scheme.
